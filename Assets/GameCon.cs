...
public class GameCon : MonoBehaviour
{
    ...
    static int upgradeRT3;
    static int upgradeRT2;
    float tttt;
    ...
    void Start()
    {
        ...
        electricity = 0;
        tttt = 0;
        if (SceneManager.GetActiveScene().name == "Sc10")
        {
            resA = 100;
            urg = 10;
            electricity = 10;
    ...
    public static void upgradeRSd()
    {
        upgradeRT3 = 1;
        upgradeRT2 = 1;
    }
    public static int upgradeRSd3()
    {
        return upgradeRT3;        
    }
    public static int upgradeRSd2()
    {
        return upgradeRT2;
    }
