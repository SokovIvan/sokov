...
public class RobotSc6 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if ((((transform.position.x - px <= 1) && (transform.position.x > px)) || ((transform.position.x - px >= -1) && (transform.position.x < px))) && (((transform.position.y - py <= 1) && (transform.position.y > py)) || ((transform.position.y - py >= -1) && (transform.position.y < py))))
        {
            ...
            if (GameCon.strar() == 1 && (SceneManager.GetActiveScene().name == "Sc7" || SceneManager.GetActiveScene().name == "Battle2"))
            {
                px = Random.Range(-30, -10);
                py = Random.Range(-60, -45);
            }
            if (GameCon.strar() == 2)
            {
                px = point.transform.position.x + Random.Range(-20, 20);
                py = point.transform.position.y + Random.Range(-20, 20);
                if (GameCon.robs() > 5 && (SceneManager.GetActiveScene().name == "Sc7" || SceneManager.GetActiveScene().name == "Battle2"))
                {
                    px = Random.Range(-30, -10);
                    py = Random.Range(-60, -45);
                }
            ...
            if (GameCon.strar() == 3)
            {
                px = point.transform.position.x + Random.Range(-20, 20);
                py = point.transform.position.y + Random.Range(-20, 20);
                if (GameCon.spiders() > 0 && (SceneManager.GetActiveScene().name == "Sc7" || SceneManager.GetActiveScene().name == "Battle2"))
                {
                    px = Random.Range(-30, -10);
                    py = Random.Range(-60, -45);
                }
